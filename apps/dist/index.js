...
//import './globals.ts';
import './index.css';
const myPage = tsplus_module_1.html `
...
const program = tsplus_module_2.map_(tsplus_module_1.render(document.body, tsplus_module_1.html `${myPage2}`), () => void 0, fileName_1 + ":136:4");
tsplus_module_3.unsafeRunPromise(program, fileName_1 + ":139:25");
